...
__turbopack_context__.s({
    ...
    "CommentsApiError": (()=>CommentsApiError),
    "CrdtType": (()=>CrdtType),
    ...
    "LiveblocksError": (()=>LiveblocksError),
    "MutableSignal": (()=>MutableSignal),
    "NotificationsApiError": (()=>NotificationsApiError),
    "OpCode": (()=>OpCode),
    "Permission": (()=>Permission),
    "Promise_withResolvers": (()=>Promise_withResolvers),
    ...
    "console": (()=>fancy_console_exports),
    "convertToCommentData": (()=>convertToCommentData),
    "convertToCommentUserReaction": (()=>convertToCommentUserReaction),
    "convertToInboxNotificationData": (()=>convertToInboxNotificationData),
    "convertToThreadData": (()=>convertToThreadData),
    "createClient": (()=>createClient),
    "createCommentAttachmentId": (()=>createCommentAttachmentId),
    ...
    "deprecate": (()=>deprecate),
    "deprecateIf": (()=>deprecateIf),
    "detectDupes": (()=>detectDupes),
    "entries": (()=>entries),
    "errorIf": (()=>errorIf),
    "freeze": (()=>freeze),
    "generateCommentUrl": (()=>generateCommentUrl),
    "getMentionedIdsFromCommentBody": (()=>getMentionedIdsFromCommentBody),
    "html": (()=>html),
    "htmlSafe": (()=>htmlSafe),
    "isChildCrdt": (()=>isChildCrdt),
    "isCommentBodyLink": (()=>isCommentBodyLink),
    "isCommentBodyMention": (()=>isCommentBodyMention),
    "isCommentBodyText": (()=>isCommentBodyText),
    "isJsonArray": (()=>isJsonArray),
    "isJsonObject": (()=>isJsonObject),
    "isJsonScalar": (()=>isJsonScalar),
    "isLiveNode": (()=>isLiveNode),
    "isNotificationChannelEnabled": (()=>isNotificationChannelEnabled),
    "isPlainObject": (()=>isPlainObject),
    "isRootCrdt": (()=>isRootCrdt),
    "isStartsWithOperator": (()=>isStartsWithOperator),
    "kInternal": (()=>kInternal),
    "keys": (()=>keys),
    ...
    "patchUserNotificationSettings": (()=>patchUserNotificationSettings),
    "raise": (()=>raise),
    "resolveUsersInCommentBody": (()=>resolveUsersInCommentBody),
    "shallow": (()=>shallow),
    "stableStringify": (()=>stableStringify),
    "stringifyCommentBody": (()=>stringifyCommentBody),
    "throwUsageError": (()=>throwUsageError),
    "toAbsoluteUrl": (()=>toAbsoluteUrl),
    "toPlainLson": (()=>toPlainLson),
...
var g = typeof globalThis !== "undefined" ? globalThis : ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : typeof global !== "undefined" ? global : {};
...
function wrap(method) {
    return ("TURBOPACK compile-time truthy", 1) ? console[method] : ("TURBOPACK unreachable", undefined);
}
var warn = wrap("warn");
...
// src/lib/freeze.ts
var freeze = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : Object.freeze;
// src/lib/signals.ts
...
function createApiClient({ baseUrl, authManager, fetchPolyfill }) {
    ...
    async function getNotificationSettings(options) {
        return httpClient.get(url`/v2/c/rooms/${options.roomId}/notification-settings`, await authManager.getAuthValue({
            requestedScope: "comments:read",
            roomId: options.roomId
        }), void 0, {
            signal: options.signal
    ...
    async function updateNotificationSettings(options) {
        return httpClient.post(url`/v2/c/rooms/${options.roomId}/notification-settings`, await authManager.getAuthValue({
            requestedScope: "comments:read",
            roomId: options.roomId
        }), options.settings);
    }
...
function createConnectionStateMachine(delegates, options) {
    ...
    if (typeof document !== "undefined") {
        const doc = typeof document !== "undefined" ? document : void 0;
        const win = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : void 0;
        const root = win ?? doc;
        machine.onEnter("*", (ctx)=>{
...
function createAuthManager(authOptions, onAuthenticate) {
    ...
    async function makeAuthRequest(options) {
        const fetcher = authOptions.polyfills?.fetch ?? (("TURBOPACK compile-time truthy", 1) ? void 0 : ("TURBOPACK unreachable", undefined));
...
var LiveList = class _LiveList extends AbstractCrdt {
   ...
   */ some(predicate) {
    ...
    /** @internal */ _toImmutable() {
        ...
        return ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : Object.freeze(result);
    }
    clone() {
...
var LiveObject = class _LiveObject extends AbstractCrdt {
    ...
    /** @internal */ _attachChild(op, source) {
        ...
        } else if (this.#propToLastUpdate.get(key) === void 0) {} else if (this.#propToLastUpdate.get(key) === opId) {
            this.#propToLastUpdate.delete(key);
            return {
                modified: false
            };
...
var LiveblocksError = class _LiveblocksError extends Error {
    ...
    /** @deprecated Prefer using `context.code` instead, to enable type narrowing */ get code() {
...
function createRoom(options, config) {
    ...
    const context = {
        ...
        // Debug
        opStackTraces: ("TURBOPACK compile-time truthy", 1) ? /* @__PURE__ */ new Map() : ("TURBOPACK unreachable", undefined)
    };
    let lastTokenKey;
...
${Array.from(traces).join("\n\n")}`);
    ...
    const events = {
        ...
        /** @deprecated */ storage: eventHub.storageBatch.observable,
    ...
    function updateNotificationSettings(settings) {
        return httpClient.updateNotificationSettings({
            roomId,
            settings
        });
    }
    ...
    function yjsStatusDidChange(status) {
        return syncSourceForYjs.setSyncStatus(status === "synchronizing" ? "synchronizing" : "synchronized");
    }
    return Object.defineProperty({
        ...
        id: config.roomId,
        subscribe: makeClassicSubscribeFn(config.roomId, events, config.errorEventSource),
...
function createClient(options) {
    ...
    const warnIfNoResolveUsers = createDevelopmentWarning(()=>!resolveUsers, "Set the resolveUsers option in createClient to specify user info.");
    ...
    const warnIfNoResolveRoomsInfo = createDevelopmentWarning(()=>!resolveRoomsInfo, "Set the resolveRoomsInfo option in createClient to specify room info.");
...
function generateCommentUrl({ roomUrl, commentId }) {
    const isAbsolute = ABSOLUTE_URL_REGEX.test(roomUrl);
    const urlObject = new URL(roomUrl, isAbsolute ? void 0 : PLACEHOLDER_BASE_URL);
...
//# sourceMappingURL=node_modules_%40liveblocks_core_dist_index_6990ddf2.js.map